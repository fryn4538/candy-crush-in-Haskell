...
/* package SpelPrototyp41-0.1.0.0 */
#define VERSION_SpelPrototyp41 "0.1.0.0"
#define MIN_VERSION_SpelPrototyp41(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "SpelPrototyp41-0.1.0.0"

#define CURRENT_PACKAGE_KEY "SpelPrototyp41-0.1.0.0"
